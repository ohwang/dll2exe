...
let githubLink = "https://github.com/ohwang/dll2exe/ohwang/dll2exe"

// Specify more information about your project
let info =
  [ "project-name", "dll2exe"
    "project-author", "ohwang"
    "project-summary", "Convert .NET into executable (or just run it)"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/dll2exe" ]
